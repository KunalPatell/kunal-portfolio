  ...
  return (
    <footer className="border-t border-white/5 bg-[#050505] py-10">
      <div className="container-px flex flex-col items-center justify-between gap-6 text-sm text-muted sm:flex-row">
        <div>
          <p>© {year} {profile.name}. Built with Next.js, FastAPI &amp; a bit of AI.</p>
          <p className="mt-1 font-mono text-xs text-[#9ed8ff]/60">
        ...
        <div className="flex items-center gap-5">
          {!isPlaceholderUrl(profile.socials.github) ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="transition-colors hover:text-[#9ed8ff]"
            >
          ...
          {!isPlaceholderUrl(profile.socials.huggingface) ? (
            <a
